        ...
        <div className="space-y-4">
          {([
            ['objectives', 'Objectives',
              `Describe the high-level business goals this project is intended to achieve.\n• What does success look like for the client?\n• How does this align with their wider IT or business strategy?\n• What key outcomes or improvements are they expecting?\n• Are there any strategic drivers (growth, compliance, modernisation)?\n\nExample:\n"Modernise the WAN infrastructure to support 500 hybrid workers across 8 UK sites, improve resilience with dual-carrier connectivity, and reduce annual circuit costs by 20%. This project underpins the client's wider cloud migration programme and must be complete before their Office 365 rollout in Q4."`],
            ['businessRequirements', 'Business Requirements',
              `List the specific, measurable requirements the solution must satisfy.\n• Functional requirements — what must the solution do?\n• Performance / availability / capacity targets\n• Compliance or security requirements (ISO 27001, Cyber Essentials, GDPR)\n• Integration requirements with existing systems\n• User or operational requirements\n\nExample:\n"• Network must support 500 concurrent VPN users with <50ms latency\n• 99.9% uptime SLA required across all primary sites\n• All traffic must be inspected by NGFW with IPS enabled\n• Must integrate with existing Microsoft Entra ID for device authentication\n• All data must remain within UK borders (data sovereignty requirement)"`],
            ['justification', 'Justification',
              `Make the business case for this investment.\n• What problem is being solved or opportunity being addressed?\n• What is the cost or risk of doing nothing?\n• What are the expected business benefits — ROI, cost savings, risk reduction?\n• Have alternatives been considered?\n\nExample:\n"The current firewall estate reaches end-of-life in August 2026 with no further vendor security patches. Two incidents in the past 12 months resulted in 14 hours of downtime costing an estimated £38,000. Maintaining the status quo exposes the client to significant regulatory and financial risk. This investment consolidates security and networking onto a single managed platform, reducing ongoing opex by an estimated £15k/year."`],
            ['constraints', 'Constraints',
              `Document any limitations that affect the solution design or delivery.\n• Budget ceiling or approved funding envelope\n• Hard deadlines (regulatory, contractual, business events)\n• Technical constraints — existing platforms, legacy systems, standards\n• Client-side resource or staffing availability\n• Procurement or approval processes\n\nExample:\n"• Approved capex budget: £95,000 (opex considered separately)\n• Solution must be live before lease renewal on 1 November 2026\n• Core systems cannot be taken offline during business hours (Mon–Fri 08:00–18:00)\n• Client IT team availability capped at 2 days/week during delivery\n• All hardware must be procured via existing Crown Commercial Service framework"`],
            ['assumptions', 'Assumptions',
              `State what we are taking as true for the purposes of this proposal.\n• Client will provide access to systems, environments and stakeholders\n• Existing infrastructure meets baseline requirements\n• Scope boundaries — what is and is not included\n• Third-party dependencies will be available as expected\n• Pricing validity period\n\nExample:\n"• A dedicated project sponsor with decision-making authority will be available throughout delivery\n• Existing server room has adequate power and cooling for the proposed hardware\n• ISP will deliver the required bandwidth upgrade within the agreed project timeline\n• Scope excludes end-user device provisioning and Wi-Fi infrastructure unless explicitly stated\n• Pricing is based on Cisco GPL (May 2026) and is valid for 30 days from proposal date\n• Any changes to the above will be managed via a formal change request process"`],
            ['notes', 'Notes',
              `Internal presales notes — not included in client-facing documents.\n• Key stakeholders and their priorities or concerns\n• Incumbent vendors or competitor landscape\n• Pricing sensitivity or budget pressure\n• Special commercial terms or approval requirements\n• Outstanding actions and next steps\n\nExample:\n"Key stakeholder: Sarah Ahmed (IT Director) — budget holder, strong preference for Cisco. Procurement lead: James Liu — requires 3 quotes for anything over £50k.\nIncumbent: BT Managed Services, contract up for renewal Q4 2026 — client frustrated with support response times.\nClient is cost-sensitive but won't sacrifice resilience. Highlight TCO savings over 3 years.\nNext steps: confirm site survey dates by 30 May, follow up with revised quote by 6 June."`],
