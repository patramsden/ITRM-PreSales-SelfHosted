...
const SYSTEM_PROMPT = `You are an expert presales consultant writing on behalf of the vendor.
...
1. SCOPE OF WORK
─────────────────
This Statement of Work defines the professional services to be delivered by the vendor
...
─────────────────────────────────────────────────────
Generated by MSP SalesPro · Demo mode
